...
namespace tri {
    ...
    public:
        ...
        //void submit(const glm::mat4& transform, const glm::vec3& position, Mesh* mesh, Texture* texture, Color color = Color::white, uint32_t id = -1);
        //void submit(const glm::mat4& transform, const glm::vec3& position, Mesh* mesh, Color color, uint32_t id = -1);
